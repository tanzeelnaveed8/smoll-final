...
import SmollBasic from "../icons/SmollBasic";
import Smollcare from "../icons/Smollcare";
import SmollVet from "../icons/SmollVet";
...
const HomeScreenBanner: React.FC<Props> = ({ navigation, plan }) => {
console.log("plane",plan)
  // #3EBEA0
  const backgroundColor = plan === "smollCare"
    ? "#6e99f0"
    : plan === "smollBasic"
      ? "#FAF8F5"
      : plan === "smollVet"
        ? "#405B7A"
        : "#FAF8F5"; // fallback color
  const borderColor = plan === "smollCare"
    ? "#6e99f0"
    : plan === "smollBasic"
      ? "#000"
      : plan === "smollVet"
  ...
  const backgroundColorbtn = plan === "smollCare"
    ? "transparent"
    : plan === "smollBasic"
      ? "#5692E9"
      : plan === "smollVet"
        ? "transparent"
        : "#6e99f0"; // fallback color
  const borderColorbtn = plan === "smollCare"
    ? "white"
    : plan === "smollBasic"
      ? "#5692E9"
      : plan === "smollVet"
  ...
  const Text = plan === "smollCare"
    ? "Access Your Plan"
    : plan === "smollBasic"
      ? "Upgrade to smoll®Care"
      : plan === "smollVet"
        ? "Upgrade to smoll®Care"
        : "Upgrade to smoll®Care";
  ...
  // console.log("first", width, height)
    const plansvg =
    plan === "smollCare"
      ? <Smollcare height={height} width={width} fillColor="#ffffff" />
      : plan === "smollBasic"
        ? <SmollBasic height={height} width={width} />
        : plan === "smollVet"
          ? <SmollVet height={height} width={width} fillColor="#fff" />
          : <SmollBasic height={height} width={width} />
      ...
      <Div px={20} pr={0} h={"100%"} flexDir="column" justifyContent="space-between">
        ...
        >
          <Tag
            ...
            pb={8}
            pt={8}
            px={plan == "smollVet" || plan == "smollCare" ? 20 : 15}
...
// <SvgXml xml={plansvg} width={width} height={height} />
