...
`;
  ...
  const { width, heights } =
    subscription === "smollCare"
      ? { width: 164, heights: 30 }
      : subscription === "smollBasic"
        ? { width: 229, heights: 38 }
        : subscription === "smollVet"
          ? { width: 153, heights: 38 }
          : { width: 229, heights: 38 };

  const plansvg =
    subscription === "smollCare"
      ? <Smollcare height={heights} width={width} fillColor="#5692E9" />
      : subscription === "smollBasic"
        ? <SmollBasic height={heights} width={width} />
        : subscription === "smollVet"
          ? <SmollVet height={heights} width={width} fillColor="#405B7A" />
          : <SmollBasic height={heights} width={width} />
  ...
  // Get subscription-specific content
    ...
    switch (subscription) {
      case "smollBasic":
        return {
          ...
          description: "Present this number at any of our partner locations and enjoy your smoll® benefits",
          bg: "#000000",
          text: "#FFFFFF"
        };
      case "smollVet":
        return {
          ...
          titleColor: "#3EBEA0",
          welcomeColor: "#858B91",
          image: require("@/assets/images/smoll-vet.png"), // You can replace with vet-specific image
          numberColor: "#405B7A",
          buttonColor: "#405B7A",
          buttonTextColor: "#FFFFFF",
          description: "Present this number at any of our partner locations and enjoy your smoll® benefits",
      ...
      case "smollCare":
        return {
          ...
          titleColor: "#679FF0",
          welcomeColor: "#679FF0",
          image: require("@/assets/images/smollcoress.png"),
          numberColor: "#679FF0",
          buttonColor: "#679FF0",
          buttonTextColor: "#FFFFFF",
          description: "Present this number at any of our partner locations and enjoy your smoll® Care benefits",
          bg: "#679FF0",
          text: "#FFFFFF"
        };
      default:
  ...
  return (
    ...
    >
      <ScrollDiv showsVerticalScrollIndicator={false}>
        <Div mt={4}>
          <Text fontSize="2xl" color={content.welcomeColor} fontFamily={fontHeading}>
            Welcome to
          </Text>
        {plansvg} 
        ...
        <Div mt={14}>
          <Div alignItems="center">
            <Div alignItems="center">
              <Text fontSize="xl" fontFamily={"HelveticaNeue-Regular"} textAlign="center" color="#000000">
                Your smoll number is
              </Text>
              <Div position="relative" alignItems="center" mt={8}>

                <Image style={{ objectFit: "contain" }} source={require("@/assets/images/careId-bg.png")} w={300} h={80} />
                <Text
                  style={{ position: "absolute" }}
                  fontSize="8xl"
                  fontFamily={"HelveticaNeue-Light"}
                  color={content.numberColor}
          ...
          >
            ...
            <Text color={content.text} fontSize={"xl"} fontFamily={fontHauoraSemiBold}>
              My Pets
            </Text>
